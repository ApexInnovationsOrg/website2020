      ...
      <div class="col-sm-8">
        ...
        <div class="row">
          <div class="col-md-12">
              <h4>imPULSE 3.0</h4>
              <div class="row">
                ECG and Chest Pain Competency Series
              </div>
          </div>
        </div>
        <div class="row">
          <div class="col-md-12 sm-margin-top">
            <p>Nine individual guideline-based courses are designed to address the educational needs of monitor techs to physicians.</p>
          </div>
        </div>
      </div>
  </div>
