...
@section('content')
    ...
    <div class="row relative sliderContainer text-center" height="auto">
		<div class="col-sm-12 slider-bottom text-center text-uppercase">
			<h2 class="bold-font">WELCOME TO APEX INNOVATIONS</h2>
		</div>
      ...
      <div class="modal-dialog">
        ...
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title">Phone outage</h4>
          </div>
          <div class="modal-body">
            <h3>Our phone provider announced that we will be experiencing a service outage until <strong>4PM central</strong>. If you still require assistance, please email <strong>support@apexinnovations.com</strong></h3>
          </div>
